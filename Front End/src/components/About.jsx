...
export default function About() {
  const backendSkills = ['Java', 'Python', 'Node.js', 'Go', 'C#'];
      ...
      <div className="container">
        <div className="about-grid">
          ...
          <div className="about-bio" id="about-bio">
            ...
            <div className="about-skills" style={{ display: 'flex', flexDirection: 'column' }}>
              <div className="skill-group" style={{ marginBottom: '0.75rem' }}>
                <strong style={{ display: 'block', marginBottom: '0.25rem' }}>Frontend:</strong>
              ...
              <div className="skill-group" style={{ marginBottom: '0.75rem' }}>
                <strong style={{ display: 'block', marginBottom: '0.25rem' }}>Backend:</strong>
                <div style={{ display: 'flex', flexWrap: 'wrap', gap: '0.5rem' }}>
              ...
              <div className="skill-group" style={{ marginBottom: '1.5rem' }}>
                <strong style={{ display: 'block', marginBottom: '0.25rem' }}>Database:</strong>
                <div style={{ display: 'flex', flexWrap: 'wrap', gap: '0.5rem' }}>
          ...
          <div className="stat-cards" style={{ display: 'flex', flexDirection: 'column', gap: '1rem', justifyContent: 'center' }}>
            <div className="stat-card reveal reveal-delay-1 is-visible" style={{ padding: '2rem', textAlign: 'center', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
              <h3 style={{ margin: 0, fontSize: '1.5rem', color: '#00A89C' }}>Software Engineer</h3>
            </div>
            <div className="stat-card reveal reveal-delay-2 is-visible" style={{ padding: '2rem', textAlign: 'center', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
              <h3 style={{ margin: 0, fontSize: '1.5rem', color: '#FFB84D' }}>Web Developer</h3>
            </div>
            <div className="stat-card reveal reveal-delay-3 is-visible" style={{ padding: '2rem', textAlign: 'center', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
              <h3 style={{ margin: 0, fontSize: '1.5rem', color: '#00A89C' }}>UI/UX Design</h3>
            </div>
          </div>
        </div>
      </div>
